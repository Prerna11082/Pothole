...
public class MainActivity extends FragmentActivity implements
	...
	public static class DummySectionFragment1 extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.location_pagetab, container, false);
			t1 = (TextView) rootView.findViewById(R.id.textView1);			
			t2 = (TextView) rootView.findViewById(R.id.textView2);	
			Intent a1 = new Intent ("android.intent.action.LOCATIONACTIVITY");
	...
	public static class DummySectionFragment2 extends Fragment {
		...
		@Override
		public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
			View rootView = inflater.inflate(R.layout.data_page, container, false);
			...
			ib1.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent in3 = new Intent ("android.intent.action.RATINGACTIVITY");
					Intent in2 = new Intent ("android.intent.action.COMMENTACTIVITY");
					Intent inimage = new Intent ("android.intent.action.IMAGEACTIVITY");
					if (image.isChecked()) {
