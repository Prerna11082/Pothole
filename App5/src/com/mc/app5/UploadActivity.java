...
public class UploadActivity extends Activity implements OnClickListener {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			ParseACL.setDefaultACL(defaultACL, true);
	         ...
	         sendButton = (ImageButton) findViewById(R.id.imageButton1);
		...
		@Override
			...
			// Locate the image in res > drawable-hdpi
					...
					String line=LocationActivity.getCoordinates();
					String noteret = CommentActivity.getnotes();
					float rateret = RatingActivity.getrate();
					...
					//ParseObject imgupload = new ParseObject("ImageUpload");
	                photoFile = new ParseFile("pothole.jpg", ImageActivity.getimage());
